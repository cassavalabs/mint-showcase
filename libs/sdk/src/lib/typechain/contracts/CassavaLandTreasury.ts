...
export interface CassavaLandTreasuryInterface extends utils.Interface {
  functions: {
  ...
  events: {
    "FundsWithdrawal(address,uint256)": EventFragment;
...
export interface FundsWithdrawalEventObject {
  to: string;
  amount: BigNumber;
}
export type FundsWithdrawalEvent = TypedEvent<
  [string, BigNumber],
  FundsWithdrawalEventObject
>;

export type FundsWithdrawalEventFilter = TypedEventFilter<FundsWithdrawalEvent>;
...
export interface CassavaLandTreasury extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CassavaLandTreasuryInterface;
  ...
  filters: {
    "FundsWithdrawal(address,uint256)"(
      to?: string | null,
      amount?: null
    ): FundsWithdrawalEventFilter;
    FundsWithdrawal(
      to?: string | null,
      amount?: null
    ): FundsWithdrawalEventFilter;
