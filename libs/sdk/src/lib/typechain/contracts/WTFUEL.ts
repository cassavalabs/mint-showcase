...
export interface WTFUELInterface extends utils.Interface {
  functions: {
...
export interface WTFUEL extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WTFUELInterface;
  ...
  supportedTokens(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
